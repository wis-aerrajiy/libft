...
<p align="center">
	<img alt="GitHub code size in bytes" src="https://img.shields.io/github/languages/code-size/theblack-wis/libft?color=blueviolet" />
	<img alt="Number of lines of code" src="https://img.shields.io/tokei/lines/github/theblack-wis/libft?color=blueviolet" />
	<img alt="Code language count" src="https://img.shields.io/github/languages/count/theblack-wis/libft?color=blue" />
	<img alt="GitHub top language" src="https://img.shields.io/github/languages/top/theblack-wis/libft?color=blue" />
	<img alt="GitHub last commit" src="https://img.shields.io/github/last-commit/theblack-wis/libft?color=brightgreen" />
</p>
...
For detailed information, refer to the [**subject of this project**](https://github.com/theblack-wis/42cursus/tree/master/_PDFs).
...
* [**📁 libft:**](libft/) updated source code, refactored for use in other projects; includes 
[`get_next_line`](https://github.com/theblack-wis/42cursus-getnextline) and 
[`printf`](https://github.com/theblack-wis/42cursus-ft_printf) functions.
